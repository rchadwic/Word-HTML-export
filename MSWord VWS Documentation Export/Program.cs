...
namespace MSWord_VWS_Documentation_Export
{
    ...
    class ContentObject
    {
        ...
        public void print(System.IO.StreamWriter outfile)
        {
            if (this.type == 0)
            {
                ...
                outfile.WriteLine("<div class='step font"+fontsize+" indent"+indent+" "+listclass+"'>" + liststring + text + "</div>");
            ...
            if (this.type == 1)
            {
               // outfile.WriteLine(((Paragraph)(this.content)).Range.Start);
                ...
                this.SaveToImage("c:\\Tutorial export\\" + filename);

                outfile.WriteLine("<img class='image' src='"+filename+"' />\n");
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Microsoft.Office.Interop.Word.Document WordDoc = WordApp.Documents.Open("c:\\users\\chadwickr\\downloads\\Building a Game in the Virtual World Sandbox.docx",ref oMissing, true);
            ...
            System.IO.StreamWriter file = new System.IO.StreamWriter("C:\\Tutorial export\\export.html");
